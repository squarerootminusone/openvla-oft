...
def make_oxe_dataset_kwargs(
    ...
    if dataset_kwargs["action_encoding"] not in [ActionEncoding.EEF_POS, ActionEncoding.EEF_R6, ActionEncoding.JOINT_POS_BIMANUAL, ActionEncoding.EEF_POS_NO_ROT]:
        raise ValueError(f"Cannot load `{dataset_name}`; only EEF_POS, EEF_R6, JOINT_POS_BIMANUAL & EEF_POS_NO_ROT actions supported!")
    ...
    elif dataset_kwargs["action_encoding"] is ActionEncoding.EEF_POS_NO_ROT:
